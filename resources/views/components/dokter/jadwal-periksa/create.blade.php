<x-layouts.app title="Tambah Jadwal Periksa">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-slate-800">Tambah Jadwal Periksa</h2>
    </div>
        ...
        <div class="card-body p-8">
            <form action="{{ route('jadwal-periksa.store') }}" method="POST">
                ...
                <div class="form-control mb-5">
                    ...
                    <select name="hari" class="select select-bordered border-2 w-full rounded-lg @error('hari') select-error @enderror" required>
                ...
                <div class="grid grid-cols-2 gap-6 mb-5">
                    <div class="form-control">
                        ...
                        <input type="time" name="jam_mulai" value="{{ old('jam_mulai') }}" class="input input-bordered border-2 rounded-lg" required>
                    </div>
                    <div class="form-control">
                        <label class="label"><span class="text-sm font-semibold text-gray-700">Jam Selesai <span class="text-red-500">*</span></span></label>
                        <input type="time" name="jam_selesai" value="{{ old('jam_selesai') }}" class="input input-bordered border-2 rounded-lg" required>
                    </div>
                </div>
                ...
                <div class="form-control mb-8">
                    ...
                    <div class="flex gap-4">
                        <label class="label cursor-pointer gap-2">
                            <input type="radio" name="status" value="1" class="radio radio-primary radio-sm" checked />
                            <span class="label-text">Aktif</span>
                        </label>
                        <label class="label cursor-pointer gap-2">
                            <input type="radio" name="status" value="0" class="radio radio-primary radio-sm" />
